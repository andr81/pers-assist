...
- Составь список задач которые остались не выполнены. По каждой выведи пользователю запрос что делать: перенести на завтра, отложить на когда-нибудь, удалить, выполнить сейчас, оставить.
...
- Получи прогноз погоды на завтра для города из `settings.yaml` и кратко его опиши
- Получи самые свежие сегодняшние новости из источников `settings.yaml`, выбери из них самые важные для социальных, политических и финансовых влияний. Составь дайджест по ним со ссылками.
