...
**Источники данных:**
   ...
   - Рекомендации по нутрициологии → `docs/dadali-recommendations.md`
   - Анализы и обследования → скил `add-med-record`
**Справочные документы:**
- `docs/dadali-recommendations.md` — рекомендации по витаминам, БАДам, питанию
